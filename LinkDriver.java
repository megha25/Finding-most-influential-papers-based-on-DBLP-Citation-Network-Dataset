...
public class LinkDriver extends Configured implements Tool {
  public static void main(String[] args) throws Exception {	  
    	int exitCode = ToolRunner.run(new Configuration(), new LinkDriver(),args);
...
//Initializing the map reduce job
	...
	job.setJarByClass(LinkDriver.class);
	job.setJobName("link");
